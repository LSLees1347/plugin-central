...
public: \
	DECLARE_CLASS(USIK_FinalizeAssetTransaction, USIK_BaseWebApi, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/SteamWeb"), NO_API) \
...
private: \
	...
	USIK_FinalizeAssetTransaction(const USIK_FinalizeAssetTransaction&); \
public: \
...
template<> STEAMWEB_API UClass* StaticClass<class USIK_FinalizeAssetTransaction>();
